...
And also to fully understand the functionalities of knowledge sharing such as software applications like GitHub,build websites for information sharing and podcasting stories to pass information to their communities
...
The areas covered in the website included; content management system, local installation of WordPress, local servers i.e. using Xamp as a local server, troubleshooting websites, introduction to page builders e.g. elementor, introduction to themes and plugins, and web content strategies. 
 ...
 The participants teamed up to build the RefugeeConnect website, an information platform that publishes content about refugees and makes access to information easy for them.
  ...
  - The trainees learned to create Repositories, fork, create files in GitHub repository, commit changes in GitHub, GitHub issues, pull requests, merge pull requests, Branches, markdown files.
   ![](Images/IMG_20220417_011725_240.jpg)
  ...
  ![](Images/IMG_20220417_012507_446.jpg)
  # long-term
...
This project was funded by the federal ministry of economic cooperation and development **(BMZ)** in berlin Germany, supported by Agency for development and critical transformation **(r0g)** through Access to skills and knowledge network **(ASKnet)** and implemented by The Youth Empowerment Foundation **(YEF)**
...
|[Official website](https://www.bmz.de/en)|[official websites](https://openculture.agency/)|[official website](https://asknet.community/#resources)|[official website](https://yef-uganda.org/)
